...
export default function MapApp({ initialSpots }: { initialSpots: Spot[] }) {
  ...
  return (
    <main className="relative h-dvh w-full overflow-hidden">
      ...
      {/* Header */}
      <header className="pointer-events-none absolute inset-x-0 top-0 z-[1000] flex flex-wrap items-start justify-between gap-2 p-3 md:p-4">
        ...
        <div className="pointer-events-auto flex flex-wrap items-center justify-end gap-2">
          ...
          <input
            ...
            className="w-40 rounded-xl bg-black/85 px-3.5 py-2.5 font-mono text-xs text-white placeholder:text-white/40 shadow-2xl backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-primary/60 md:w-52"
          />
